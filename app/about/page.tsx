...
const FAQ = [
  ...
  {
    q: "방송은 언제 공개되나요?",
    a: "모태솔로지만 연애는 하고 싶어 시즌2는 총 10부작으로, 2026년 7월 7일 1~4회가 공개됐고 이후 매주 화요일 오후 5시에 2회씩 공개됩니다. 7월 14일 5-6회, 7월 21일 7-8회, 7월 28일 9-10회(최종회) 순서입니다. 각 공개 직전이 예측 락인 마감입니다.",
  },
  {
    q: "로그인이 필요한가요?",
